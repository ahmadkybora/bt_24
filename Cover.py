...
from telegram import Update, ReplyKeyboardMarkup, ChatAction, ParseMode, ReplyKeyboardRemove, InlineKeyboardMarkup
...
from utils import download_file, create_user_directory, convert_seconds_to_human_readable_form, \
    ...
    generate_module_selector_voice_keyboard, generate_tag_editor_video_keyboard
...
def handle_convert_video_to_gif_message(update: Update, context: CallbackContext) -> None:
    ...
    user_data['current_active_module'] = 'convert_video_to_gif_message'
...
def show_language_keyboard(update: Update, _context: CallbackContext) -> None:
    language_button_keyboard = InlineKeyboardMarkup(
        [
            ['🇬🇧 English', '🇮🇷 فارسی'],
        ],
